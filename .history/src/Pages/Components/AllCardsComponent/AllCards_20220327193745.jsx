    ...
    <>
      <section className="Wrapper">
                          ...
                          return (
                            <>
                              <div className="Card" key={tems.key}>
                                ...
                                <p>{tems.p}</p>
                                <h3>{`$${tems.h3}`}</h3>
                                <button onClick={()=>setModal((modal) =>!modal)} >Add To Cart</button>
                              </div>
                            </>
                          );
                        })}
        ...
        <div className="ModalCard">
            ...
            <button className="Bton" type="Submit"><div className="d-flex justify-content-between"><p>Add To Cart</p><p>34.00$</p></div></button>></form>
          </div>
        </Modal>
      </section>
    </>
