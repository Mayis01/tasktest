...
import { Container, Nav, Navbar, NavbarBrand, OffcanvasBody, OffcanvasHeader, OffcanvasTitle } from "react-bootstrap";
...
export default function Header() {
  ...
  return (
    <>
      ...
      </header><Navbar className={style.navbar} expand={false}>
          <Container fluid>
            <Navbar.Toggle
