        ...
        <Container fluid className="mt-2">
          ...
          >
            <OffcanvasHeader closeButton>
              <OffcanvasTitle id="offcanvasNavbarLabel " className="d-flex justify-content-center">
                <NavbarBrand >
                  {" "}
                  <img src={logo} className={style.ResponseLogo} alt="" />{" "}
                </NavbarBrand>
              </OffcanvasTitle>
            </OffcanvasHeader>
            <OffcanvasBody>
